...
public class AuxiliaryBookEmailTaskHandler implements ScheduledTaskHandler {

    private final AuxiliaryBookScheduledExecutor executor;

    @Override
    public ScheduledTaskType supports() {
        return ScheduledTaskType.AUXILIARY_BOOK_EMAIL;
    }

    @Override
    public TaskExecutionResult handle(ScheduledTask task) {
        return this.executor.execute(task, ScheduledTaskType.AUXILIARY_BOOK_EMAIL);
    }
}
